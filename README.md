...
| Item | Value |
|------|-------|
| **Repository** | [`prismteam-ai/chief-of-staff-communication-agent`](https://github.com/prismteam-ai/chief-of-staff-communication-agent) |
| **Fork** | [`EranTenenboim/chief-of-staff-communication-agent`](https://github.com/EranTenenboim/chief-of-staff-communication-agent) |
...
```bash
git clone git@github.com:EranTenenboim/chief-of-staff-communication-agent.git
