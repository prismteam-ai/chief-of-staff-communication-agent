/**
 * Chief of Communications — MCP server for Cursor (and any MCP client).
 *
 * Exposes the agent layer as tools: dashboard stats, unanswered messages,
 * pending approvals, approve/reject/provide-context, run agents, and live
 * Asana status reports.
 *
